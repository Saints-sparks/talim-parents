...
/** The round frame an avatar image or its initials sit in. */
...
/** The photo; Radix shows the fallback until it loads (or if it fails). */
...
/** What shows when there is no photo: usually the initials. */
