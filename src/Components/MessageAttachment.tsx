 ...
 * @param props.message - A normalized message (`attachments`, `duration`, `status`, `uploadProgress`).
 * @param props.isUserMessage - Own messages sit on the dark bubble.
 * @returns The attachment grid, or nothing when there are none.
 */
function MessageAttachment({ message, isUserMessage = false }: { message: ChatMessage; isUserMessage?: boolean }) {
